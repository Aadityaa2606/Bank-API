...
type SimpleBankClient interface {
	CreateUser(ctx context.Context, in *CreateUserResquest, opts ...grpc.CallOption) (*CreateUserResponse, error)
...
func (c *simpleBankClient) CreateUser(ctx context.Context, in *CreateUserResquest, opts ...grpc.CallOption) (*CreateUserResponse, error) {
...
type SimpleBankServer interface {
	CreateUser(context.Context, *CreateUserResquest) (*CreateUserResponse, error)
...
func (UnimplementedSimpleBankServer) CreateUser(context.Context, *CreateUserResquest) (*CreateUserResponse, error) {
...
func _SimpleBank_CreateUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SimpleBankServer).CreateUser(ctx, req.(*CreateUserResquest))
	}
